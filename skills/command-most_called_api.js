...
module.exports = function (controller) {
    ...
    controller.hears(["most called API for trusted-consumer", "most called API for trusted consumer"], 'direct_message,direct_mention', function (bot, message) {
    ...
    controller.hears(["most called API for trusted-services", "most called API for trusted services"], 'direct_message,direct_mention', function (bot, message) {
    ...
    controller.hears(["most called API"], 'direct_message,direct_mention', function (bot, message) {
	...
	controller.hears(["most 5 called API", 
                    "top 5 API",
                    "top 5 called API",
